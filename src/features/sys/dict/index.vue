...
const dictItemDrawerRef = ref<InstanceType<typeof DictItemDrawer> | null>(null)

const openDictItemDrawer = async (row: SysDictData) => {
  await dictItemDrawerRef.value?.open(row)
}
        ...
        >
          <template #action="{ row }">
            <div flex justify-center gap-2>
              ...
              <n-button type="success" ghost size="small" @click="openDictItemDrawer(row)">
                字典项
              </n-button>
