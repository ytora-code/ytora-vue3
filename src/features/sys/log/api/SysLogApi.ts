...
class SysLogApi extends BaseApi {
  constructor() {
    super('/sys/log')
  }
   ...
   * 分页请求
   */
  page = (params: SysLogParam & PageParam) => {
    return this.get<PageData<SysLogData>, SysLogParam & PageParam>('page', {
      ...params,
      sql_order_col: 'createTime↓',
    } as SysLogParam & PageParam)
  }
  ...
  queryById = (id: string | number) => {
    return this.get<SysLogData, { id: string | number }>('queryById', { id })
  }

  /**
   * 新增或编辑
   */
  upsert = (data: SysLogParam) => {
    return this.post<unknown, SysLogParam>('upsert', data)
  }
   ...
   * 导出数据
   */
  export = (params: SysLogParam) => {
    return this.download<SysLogParam>('export', params)
  }

  // ============================== 其他 =================================>
}

export default new SysLogApi()
