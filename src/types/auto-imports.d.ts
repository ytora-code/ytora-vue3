...
declare global {
  ...
  const dialog: typeof import('@/utils/naiveApi').dialog
  const effectScope: typeof import('vue').effectScope
  ...
  const loadingBar: typeof import('@/utils/naiveApi').loadingBar
  const markRaw: typeof import('vue').markRaw
  const message: typeof import('@/utils/naiveApi').message
  const nextTick: typeof import('vue').nextTick
  const notification: typeof import('@/utils/naiveApi').notification
